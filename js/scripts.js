...
function updateCountdown() {
    // Fecha de la boda: 27 de Septiembre 2025 a las 15:30 (hora de Caracas)
    const weddingDate = new Date('2025-09-27T15:00:00-04:00');
    const now = new Date();
...
// Función para codificar texto para URL
...
function sendWhatsAppMessage(event) {
    ...
    if (!asistencia) {
        showAlert('Por favor selecciona si asistirás o no', 'danger');
        return false;
    }

    const telefono = '59178361225';
